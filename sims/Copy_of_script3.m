...
datakhaled = load('geplotdata.txt');
strive = load('gdplotdata.txt');
...
set(h1,'MarkerSize',15,'Marker','.','DisplayName','CPLEX OPT',...
...
set(h2,'MarkerSize',15,'Marker','.','DisplayName','GEA',...
    'Color',[0 0 1],'LineWidth',1);
hold off;
%hold on;
...
% Create ylabel
ylabel('Maximised valuation','FontSize',12);

% Create title
%title('maxPA for scenario FUM','FontSize',14);

% Create legend
legend1 = legend({'GVA','CPLEX OPT','GDA','GRA','GEA'});
